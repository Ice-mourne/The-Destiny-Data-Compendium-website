import { LineText, Description as descriptionInterface } from '@interfaces/descriptions/descriptions'
...
export function Description({ description }: { description: descriptionInterface[] }): JSX.Element | null {
